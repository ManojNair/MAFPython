...
└────┬─────┘
     ...
     ▼
  [APPROVAL TEAM] Action requires approval: process_refund
  [APPROVAL TEAM] Approve this action? (yes/no): ◄── approval team decides
```
...
You: Yes please, and I'd like a full refund.
  ...
  [APPROVAL TEAM] Approve this action? (yes/no): yes
